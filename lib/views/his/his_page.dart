...
class hisPage extends StatefulWidget {
  ...
  @override
  State<hisPage> createState() => _PoinPageState();
}

class _PoinPageState extends State<hisPage> {
  @override
        ...
        body: DefaultTabController(
          ...
          child: NestedScrollView(
            ...
            body: Padding(
              ...
              child:
                  Consumer<hisProvider>(builder: (context, provider, child) {
                return TabBarView(
