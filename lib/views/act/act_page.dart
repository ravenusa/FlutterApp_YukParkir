...
class ActPage extends StatefulWidget {
  ...
  @override
  State<ActPage> createState() => _PoinPageState();
}

class _PoinPageState extends State<ActPage> {
  @override
        ...
        body: DefaultTabController(
          ...
          child: NestedScrollView(
            ...
            body: Padding(
              ...
              child:
                  Consumer<ActProvider>(builder: (context, provider, child) {
                return TabBarView(
